<template>
  <div class="page-container">
    ...
    <div style="text-align:center;margin-top:16px"><el-button type="warning" @click="openBuyCard">购买VIP卡密 →</el-button></div>
  </div>
</template>
...
function openBuyCard() { window.open('/#/buy-card', '_blank') }
</script>
