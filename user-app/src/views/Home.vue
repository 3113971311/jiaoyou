<template>
  <div class="page-container">
    <div v-if="!auth.isVip" class="glass-card" style="margin-bottom:16px;text-align:center;cursor:pointer" @click="$router.push('/vip')"><span style="color:var(--accent);font-weight:600">开通VIP会员，解锁全部功能 →</span></div>
    <el-row :gutter="16">
...
const shortcuts = [
  ...
  { label: '聊天', icon: ChatDotSquare, path: '/chat', color: '#34c759' },
