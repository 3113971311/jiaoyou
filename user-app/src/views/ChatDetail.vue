<template>
  <div style="display:flex;flex-direction:column;min-height:100vh;background:var(--bg)">
    ...
    <div style="display:flex;align-items:center;gap:clamp(4px,1vw,12px);padding:clamp(6px,1vw,12px);background:var(--card-bg);border-top:1px solid var(--card-border)">
...
import { getMessages, uploadChatImage, userImageUrl } from '../api'
