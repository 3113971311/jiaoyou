...
const LABELS = {
  ...
  alipay_app_id:      { label: '支付宝 APPID',     desc: '支付宝开放平台应用ID', group: '支付配置' },
  alipay_private_key: { label: '支付宝私钥',       desc: '应用私钥 (RSA2)', group: '支付配置', type: 'textarea' },
  alipay_public_key:  { label: '支付宝公钥',       desc: '支付宝公钥', group: '支付配置', type: 'textarea' },
  wechat_app_id:      { label: '微信支付 APPID',   desc: '微信商户平台应用ID', group: '支付配置' },
  wechat_mch_id:      { label: '微信商户号',       desc: '微信支付商户号', group: '支付配置' },
  wechat_api_v3_key:  { label: '微信 APIv3 密钥',  desc: '微信支付APIv3密钥', group: '支付配置', type: 'password' },
